...
在入库参数中，有xml文件名与表对应关系，在处理文件之前先查询mysql的数据字典，把表的字段信息拿出来，有了字段和表的信息就可以拼接出插入和修改表的SQL语句，再准备插入和修改表的SQL语句绑定输入变量 
...
![image-20230421204255613](images/image-20230421204255613.png)

![image-20230421204430426](images/image-20230421204430426.png)

### 实现这个类的功能

![image-20230421204745605](images/image-20230421204745605.png)

获取指定表的全部字段信息

![image-20230421204941138](images/image-20230421204941138.png)![image-20230421205012021](images/image-20230421205012021.png)

 获取指定表的主键字段信息。

![image-20230421205056820](images/image-20230421205056820.png)
...
![image-20230421205424179](images/image-20230421205424179.png)

在业务处理主函数中添加

![image-20230421205654530](images/image-20230421205654530.png)
