实现加载入库参数，解析参数，读取目录中的文件，备份文件

准备
===

<img src="images/image-20230421085611829.png" alt="image-20230421085611829" style="zoom: 25%;" />
...
![image-20230421083711525](images/image-20230421083711525.png)
...
![image-20230421083941879](images/image-20230421083941879.png)

再来写查找容器的函数

![image-20230421084026649](images/image-20230421084026649.png)

三、
---

加载入库的参数的代码，不能只加载一次参数，也不能每次循环都加载参数，不太合适，最好的方法是每隔一段时间加载一次参数，使用计数器

![image-20230421084913656](images/image-20230421084913656.png)

四、打开，处理(待入库文件目录)starg.xmlpath
---

主函数中

![image-20230421090033515](images/image-20230421090033515.png)

### 写函数的结构体

![image-20230421090404402](images/image-20230421090404402.png)

把xml文件移动到备份目录或者错误目录

![image-20230421090520317](images/image-20230421090520317.png)
