...
![image-20230421000529266](images/image-20230421000529266.png)

2 打开文件进行处理
---

![image-20230421001400593](images/image-20230421001400593.png)

3
---

 这个做法是把结果集全部的记录保存在一个文件中，不太合理，在以下这几个步骤进行解决

<img src="images/image-20230421001903915.png" alt="image-20230421001903915" style="zoom: 33%;" />

4
---

在这里进行修改，生成文件名需要修改，因为现在项目；文件的命名方式是前缀加当前时间加后缀，如果在同一秒内生成多个文件会重复，所以我们要给他增加一个序号

![image-20230421002444767](images/image-20230421002444767.png)
