...
可以用输入重定向的方式执行脚本文件，但我们的调度程序不支持输入重定向，我们只能自己写一个执行sql脚本的程序，这个小工具程序对维护人员很管用，可以用来执行一些小任务

/root/project/idc/sql/cleardata.sql

/root/project/tools1/c/execsql1.cpp
