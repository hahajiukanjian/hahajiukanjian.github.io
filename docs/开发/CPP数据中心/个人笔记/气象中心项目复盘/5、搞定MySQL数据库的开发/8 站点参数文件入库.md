...
![image-20230420111203283](images/image-20230420111203283.png)
...
/root/project/idc/c/obtcodetodb1.cpp
...
这个程序心跳时间很短如果我们用gdb调试代码的时候很容易被守护进程杀掉，那么我们在调试代码的时候，将进程的心跳给注释掉，要么就设置一个很长的时间
