准备![image-20230420005100898](images/image-20230420005100898.png)
===
...
![image-20230420011151574](images/image-20230420011151574.png)



![image-20230420011219315](images/image-20230420011219315.png)
...
如果SQL语句的主体没有改变，只需要prepare()一次就可以了；  这一点非常重要，不要重复的prepare再重新的绑定，浪费cpu资源，而且每次执行prepare客户端会把sql语句发给服务端去验证，会产生一次网络通信的开销
